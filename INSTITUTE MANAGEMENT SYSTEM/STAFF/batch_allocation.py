...
app.title("Batch Allocation Form")
...
def logic():
    try:
        ...
        ts = total_students_entry.get()
        cr = course_entry.get()

        sql = "insert into baf values('" + dt + "','" + fn + "','" + bt + "','" + ts + "','" + cr + "')"
...
total_students_entry=ctk.CTkEntry(master=frame,placeholder_text="Number of Students:")
total_students_entry.pack(pady=12,padx=10)
