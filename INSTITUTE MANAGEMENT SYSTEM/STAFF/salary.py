...
def logic():
    try:
        ...
        sql = "insert into sf values('" + dt + "','" + fn + "','" + pt + "','" + sl + "','" + md + "')"
...
salary_entry=ctk.CTkEntry(master=frame,placeholder_text="Salary Amount:")
salary_entry.pack(pady=12,padx=10)
