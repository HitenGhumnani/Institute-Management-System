...
mycursor.execute("SELECT * FROM exff")
...
label = tk.Label(root, text="EXAM FEES", font=("Arial", 14, "bold"))
label.grid(row=0, column=0, padx=10, pady=5)

headers = ["Date", "Fullname", "Exam Name", "Exam Fees", "Particulars [if any]", "Mode of Payment"]
...
widths = [100,100,150,100,200,100]
