...
mycursor.execute("SELECT * FROM exf")
...
label = tk.Label(root, text="EXAMINATION", font=("Arial", 14, "bold"))
label.grid(row=0, column=0, padx=10, pady=5)

headers = ["Date", "Fullname", "Address", "City", "Mobile Number", "Email Id", "Exam Name" , "Session", "Exam Fees"]
...
widths = [100,100,200,100,100,200,150,100,100]
