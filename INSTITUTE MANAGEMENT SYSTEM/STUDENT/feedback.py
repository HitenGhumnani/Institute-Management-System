...
def logic():
    try:
        ...
        fb = feedback_entry.get()
        stf = staff_entry.get()

        sql = "insert into fbf values('" + dt + "','" + fn + "','" + mn + "','" + eq + "','" + fb + "','" + stf + "')"
...
fullname_entry=ctk.CTkEntry(master=frame,placeholder_text="Full Name:")
...
feedback_entry=ctk.CTkEntry(master=frame,placeholder_text="Feedback:")
feedback_entry.pack(pady=12,padx=10)
