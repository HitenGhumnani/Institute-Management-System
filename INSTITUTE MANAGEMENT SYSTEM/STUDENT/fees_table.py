...
mycursor.execute("SELECT * FROM fef")
...
label = tk.Label(root, text="FEES", font=("Arial", 14, "bold"))
label.grid(row=0, column=0, padx=10, pady=5)

headers = ["Date", "Fullname", "Month", "Particulars [if any]", "Fees Amount", "Staff"]
...
widths = [100,100,100,200,100,100]
