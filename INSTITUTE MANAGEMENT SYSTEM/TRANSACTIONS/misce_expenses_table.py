...
mycursor.execute("SELECT * FROM mef")
...
label = tk.Label(root, text="MISCELLANEOUS EXPENSES", font=("Arial", 14, "bold"))
label.grid(row=0, column=0, padx=10, pady=5)

headers = ["Date", "Fullname", "Particulars [if any]", "Amount Collected", "Mode of Payment"]
