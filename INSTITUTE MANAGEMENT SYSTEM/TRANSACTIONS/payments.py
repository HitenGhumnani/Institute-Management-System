...
def logic():
    try:
        ...
        sql = "insert into pf values('" + dt + "','" + fn + "','" + pt + "','" + pr + "','" + amt + "','" + md + "')"
...
party_entry=ctk.CTkEntry(master=frame,placeholder_text="Party Name:")
party_entry.pack(pady=12,padx=10)

amount_entry=ctk.CTkEntry(master=frame,placeholder_text="Amount Collected:")
