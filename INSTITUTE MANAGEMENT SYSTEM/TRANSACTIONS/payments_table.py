...
mycursor.execute("SELECT * FROM pf")
...
label = tk.Label(root, text="PAYMENT", font=("Arial", 14, "bold"))
label.grid(row=0, column=0, padx=10, pady=5)

headers = ["Date", "Fullname", "Particulars [if any]", "Party Name", "Amount Collected", "Mode of Payment"]
...
widths = [100,100,200,200,100,100]
